...
class TestRot13:
    def test_encode_rot13(self) -> None:
        """Checks that text encodes correctly to ROT13."""
        assert encode_rot13(b"Hello World!") == "Uryyb Jbeyq!"

    def test_decode_rot13(self) -> None:
        """Checks that a ROT13 string decodes back correctly."""
        assert decode_rot13("Uryyb Jbeyq!") == b"Hello World!"

    def test_roundtrip(self) -> None:
        """Encodes then decodes and checks it matches the original bytes."""
        original = b"The quick brown fox jumps over the lazy dog"
        assert decode_rot13(encode_rot13(original)) == original
